  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved question as @question" do
        ...
        post :create, {:question => { "text" => "invalid value" }}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested question" do
        ...
        Question.any_instance.should_receive(:update_attributes).with({ "text" => "MyString" })
        put :update, {:id => question.to_param, :question => { "text" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the question as @question" do
        ...
        put :update, {:id => question.to_param, :question => { "text" => "invalid value" }}, valid_session
        assigns(:question).should eq(question)
      end
