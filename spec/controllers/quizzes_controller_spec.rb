  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved quiz as @quiz" do
        ...
        post :create, {:quiz => { "name" => "invalid value" }}, valid_session
        assigns(:quiz).should be_a_new(Quiz)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested quiz" do
        ...
        Quiz.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => quiz.to_param, :quiz => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the quiz as @quiz" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Quiz.any_instance.stub(:save).and_return(false)
        put :update, {:id => quiz.to_param, :quiz => { "name" => "invalid value" }}, valid_session
        assigns(:quiz).should eq(quiz)
      end
